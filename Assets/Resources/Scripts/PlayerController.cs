...
//using InputAction.actionTiggered;

//Controls For unitys Old Input System 
...
public class PlayerController : MonoBehaviour
{
    ...
    void Update() 
    {
        ...
        //For rotating the Main Player with the Mouse 
       /*
    ...
    //Old input Manager Controls
    //Use Only if wanting to use WASD Keys & Mouse Controls 
    void FixedUpdate()
    {
        // Move the player
        ...
        */
        // Using the controller (Unfinshed Code)
    ...
    //Damaging System for Main Player 
    ...
    //Shooting System for Main Player Linked only For mouse Control
    void Shoot()
    {
